<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyBillOutput.aspx.cs" Inherits="Plugins_WanLi_BillData_ModifyBillOutput" %>
                                ...
                                <ext:Container runat="server" Layout="HBoxLayout" Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtModifyLineGuid" runat="server" FieldLabel="产品GUID" LabelAlign="right"
                                            Flex="1" Enabled="true" MaxLength="80">
                                        </ext:TextField>
                                    </Items>
                                </ext:Container>
                            </Items>

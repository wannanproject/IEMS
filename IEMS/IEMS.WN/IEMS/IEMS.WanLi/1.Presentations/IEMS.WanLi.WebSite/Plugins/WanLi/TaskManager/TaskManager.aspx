<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskManager.aspx.cs" Inherits="Plugins_WanLi_TaskManager_TaskManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var saveAddWindows = function () {
            ...
            if ((palletNo1 == null || palletNo1 == "")) {
                Ext.Msg.alert("错误", '请选择入库工装!');
                return;
            }
            App.direct.RequestTaskCmd(palletNo1, null, sLocPlcNo, {
                success: function (result) {
                    if (result == "") {

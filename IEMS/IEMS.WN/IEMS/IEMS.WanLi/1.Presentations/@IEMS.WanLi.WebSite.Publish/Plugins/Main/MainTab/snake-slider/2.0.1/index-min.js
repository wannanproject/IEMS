KISSY.add("snake-slider/2.0.1/lib/extensible",function(t,e){var i={combine:function(i,n){var c,r,a=this._cloneDeeply(this)
...
return i},{requires:["base"]}),KISSY.add("snake-slider/2.0.1/lib/dom-transform",function(t,e){var i={transform:function(t,e){return new this(this.dom2config(t,e))},dom2config:function(t,i){var n,c,r={transformParam:i},a=this._domTransformer
if(a&&(t=e.get(t)))if(n=a.length)for(c=0;n>c;++c)a[c].apply(this,[r,t,i])
else a.apply(this,[r,t,i])
return r}}
return i},{requires:["dom"]}),KISSY.add("snake-slider/2.0.1/lib/event-configurable",function(){var t={bindEventConfiguration:function(t,e){if(e){var i,n,c
for(t instanceof Array||(t=[t]),c=t.length;--c>-1;)i=t[c],(n=e["on"+i])&&"function"==typeof n&&this.on(i,n,this)}}}
return t}),KISSY.add("snake-slider/2.0.1/lib/switching",function(t,e,i,n,c,r){var a=function(){}
...
return t.mix(l,r),a},{requires:["dom","event","./extensible","./dom-transform","./event-configurable"]}),KISSY.add("snake-slider/2.0.1/lib/auto-switch",function(t,e){var i=function(){}
...
n>0&&(t.switchInterval=n)},i},{requires:["dom"]}),KISSY.add("snake-slider/2.0.1/lib/indicator",function(t,e,i){var n=function(){}
...
t&&e.remove(t)}},n},{requires:["dom","event"]}),KISSY.add("snake-slider/2.0.1/lib/lazy-render",function(t,e){var i=function(){}
...
t&&!this._lazyRendered&&(e.style(t,"display","none"),e.insertBefore(e.create(e.html(t)),t,!0),this._lazyRendered=!0,this.fire("lazyrender"))}},i},{requires:["dom"]}),KISSY.add("snake-slider/2.0.1/lib/slice-switch-effect",function(KISSY,DOM,LayerAnim){var SwitchEffect=function(){}
...
return(e=this._getSliceEffect(!1,t.sliceActived,this,this.displayInactiveSliceStyle))?(e.run(),!1):void 0},stopEffect:function(t){if(t){var e;(e=this[t+"Anim"])&&e.stop()}else this.stopEffect("activeEffect"),this.stopEffect("inactiveEffect")},pauseEffect:function(t){if(t){var e;(e=this[t+"Anim"])&&e.pause()}else this.pauseEffect("activeEffect"),this.pauseEffect("inactiveEffect")},resumeEffect:function(t){if(t){var e;(e=this[t+"Anim"])&&e.resume()}else this.resumeEffect("activeEffect"),this.resumeEffect("inactiveEffect")}},SwitchEffect},{requires:["dom","layer-anim/2.0.0/"]}),KISSY.add("snake-slider/2.0.1/lib/indicator-switch-effect",function(KISSY,DOM,LayerAnim){var IndicatorSwitchEffect=function(){},SliceIndicatorSwitchEffect=IndicatorSwitchEffect.CHILD_WIDGET=function(){},propValidator=function(t){return t&&"object"==typeof t}
...
return n?(i+="Anim",e=this[i],e=this[i]=new LayerAnim(n)):void 0},_runActiveIndicatorEffect:function(){var t;(t=this._getIndicatorEffect(!0))&&t.run()},_runInactiveIndicatorEffect:function(){var t;(t=this._getIndicatorEffect(!1))&&t.run()},stopIndicatorEffect:function(t){if(t){var e;(e=this[t+"Anim"])&&e.stop()}else this.stopIndicatorEffect("activeIndicatorEffect"),this.stopIndicatorEffect("inactiveIndicatorEffect")}},IndicatorSwitchEffect},{requires:["dom","layer-anim/2.0.0/"]}),KISSY.add("snake-slider/2.0.1/lib/slice-management",function(KISSY){var Management=function(){}
...
return t?t.removeSlice(this.get("index")):void 0}},Management}),KISSY.add("snake-slider/2.0.1/index",function(t,e,i,n,c,r,a,s,o){var l=function(){}

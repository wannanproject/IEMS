<%@ page language="C#" autoeventwireup="true" inherits="Plugins_WanLi_BillTaskCmd_BillTaskCmdConnect, IEMS.WanLi.WebSite" %>
                                        ...
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5"
                                            ...
                                            <Items>
                                                ...
                                                <ext:ComboBox ID="txtSearchLineStatus" runat="server" FieldLabel="执行情况" ReadOnly="false" Editable="false"
                                                    LabelAlign="Right">
                                                    <Items>
                                                        <ext:ListItem Value="0" Text="所有" />
                                                        <ext:ListItem Value="1" Text="等待" />
                                                        <ext:ListItem Value="2" Text="下达" />
                                                        <ext:ListItem Value="3" Text="完成" />

<%@ page language="C#" autoeventwireup="true" inherits="Plugins_WanLi_BinManager_ProductStatistics, IEMS.WanLi.WebSite" %>
                ...
                <ext:GridPanel ID="gridMain" runat="server" Floatable="false" ColumnLines="true" RowLines="true">
                            ...
                            <Model>
                                <ext:Model runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="PAL_BIN" />
                                        <ext:ModelField Name="FG_BIN" />
                                        <ext:ModelField Name="RES_BIN" />
                                        <ext:ModelField Name="EMPTY_BIN" />
                                        <ext:ModelField Name="fSTO_RATE" />
                                        <ext:ModelField Name="fUSE_RATE" />
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" DataIndex="TOTAL_BIN" Text="库位数" Flex="1" />
                            <ext:Column runat="server" DataIndex="PAL_BIN" Text="空笼库存数" Flex="1" />
                            ...
                            <ext:Column runat="server" DataIndex="fSTO_RATE" Text="库存使用率" Flex="1" />
                            <ext:Column runat="server" DataIndex="fUSE_RATE" Text="库位占有率" Flex="1" />

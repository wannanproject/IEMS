...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var gridMainFresh = function () {
            var data = App.txtXCellBinNo.getValue();
            setBinStaus("正在查询行【" + data + "】的库位信息……");
            App.direct.GetStoreStatus(data);
            return false;
        }
    </script>
        ...
        var columns_renderer = function (value, a) {
            ...
            if (data.UsedFlag != 1) {
                ...
                if ("$" == binStatus) {
                    ...
                    if ("C" == bizStatus) {
                        a.style = "color:White;background-color:#005577; !important;"
                    }
                }
            }
            return status;
    ...
    <script type="text/javascript">
        var oncellover = function (e, data) {
            ...
            var html = "编号：" + data.BinNo + "<br\>";
            html = html + "可用：" + data.UsedFlag + "<br\>";
            html = html + "状态：" + data.BinStatus + "<br\>";
            html = html + "状态：" + data.BinBizStatus + "<br\>";
            html = html + "物料：" + data.ProductGuid + "<br\>";
            html = html + "数量：" + data.ProductQty + "<br\>";
            html = html + "批次号：" + data.BatchNo + "<br\>";
    ...
    <script type="text/javascript">
        ...
        var timeout_setonmouseover = function () {
            ...
            var data = App.txtXCellBinNo.getValue();
            setBinStaus("行【" + data + "】的库位信息更新完成！");

        }
        var setonmouseover = function () {
            var data = App.txtXCellBinNo.getValue();
            setBinStaus("行【" + data + "】的库位信息查询完成！");
    ...
    <form runat="server">
        ...
        <ext:Viewport ID="viewport" runat="server" Layout="border">
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:ComboBox ID ="txtXCellBinNo" runat="server" FieldLabel="库位-行号" ReadOnly="false" Width="320" Text="1"
                ...
                <ext:FormPanel ID="panelMainDetail" runat="server" Region="East" BodyPadding="5" Width="200" Collapsible="true" Collapsed="false"
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                            <Items>
                                ...
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="库位状态" Name="BinBizStatus" />
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="物料名称" Name="ProductGuid" />
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="货物数量" Name="ProductQty" />

<%@ page language="C#" autoeventwireup="true" inherits="Plugins_WanLi_BillManager_Output_AddBillOutput, IEMS.WanLi.WebSite" %>
            ...
            <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" DataIndex="ORDER_NO" Text="单行行号" Width="120" />
                            <ext:Column runat="server" DataIndex="LINE_STATUS" Text="单行行状态" Width="80" />
                            <ext:Column runat="server" DataIndex="LIMIT_BIN_NO" Text="发起站台" Width="60" />
                            <ext:Column runat="server" DataIndex="ELOC_NO" Text="目的站台" Width="60" />
                            <ext:Column runat="server" DataIndex="LIMIT_PALLET_ID" Text="RFID号" Width="100"  />
                            <ext:Column runat="server" DataIndex="MATERIAL_NO" Text="物料编码" Width="100"/>

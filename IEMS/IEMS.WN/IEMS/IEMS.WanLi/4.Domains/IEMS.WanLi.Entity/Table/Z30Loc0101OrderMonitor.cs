...
namespace IEMS.WanLi.Entity
{
    ...
    /// <summary>
    /// 订单监控 [Z30_LOC_0101_ORDER_MONITOR] - 实体类
    /// </summary>
    [Entity(TableName = "Z30_LOC_0101_ORDER_MONITOR", Description = "订单监控")]
    public class Z30Loc0101OrderMonitor : BaseEntity
    {
        /// <summary>
        /// 站台号码
        /// </summary>
        ...
        /// <summary>
        /// 请求标志 1：有请求  2: 已处理   0：无请求
        /// </summary>
        [Field(FieldName = "REQUEST_FLAG", Description = "请求标志 1：有请求  2: 已处理   0：无请求",

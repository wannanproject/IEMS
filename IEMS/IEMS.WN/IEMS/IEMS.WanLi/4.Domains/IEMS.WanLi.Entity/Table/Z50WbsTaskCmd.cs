...
namespace IEMS.WanLi.Entity
{
    ...
    /// <summary>
    /// WBS_TASK_COMMAND [Z50_WBS_TASK_CMD] - 实体类
    /// </summary>
    [Entity(TableName = "Z50_WBS_TASK_CMD", Description = "WBS_TASK_COMMAND")]
    public class Z50WbsTaskCmd : BaseEntity
    {
        /// <summary>
        /// 指令ID 序列
        /// </summary>
        ...
        /// 
        /// </summary>
        [Field(FieldName = "BK_OBJID", Description = "",
               DbType = "NUMBER(20)", DefaultValue = "",
               IsPrimaryKey = false, IsIdentity = false, Nullable = true)]
        public long? BkObjid { get; set; }
    }
}

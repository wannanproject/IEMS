<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainFrame.aspx.cs" Inherits="Plugins_Main_MainFrame" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>WMS智能化物流管理系统</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="foot_div" class='foot'>
            ...
            软控股份有限公司 &copy;<%= DateTime.Now.ToString("yyyy") %> 信息物流系统事业部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V&nbsp;<%= Vision() %>&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </form>
</body>
</html>
